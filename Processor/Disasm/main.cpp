...
int main() {
    ...
    const char asm_file_name[] = "/Users/andrew_borovets/Desktop/proga/DED/Compiler-technologies-and-professional-programming/Processor/new_asm.txt";
    ...
    assert(-1 != getAsm(asm_file_name, code_file_name));
