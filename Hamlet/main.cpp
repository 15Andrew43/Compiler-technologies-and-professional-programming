...
int main() {
    ...
    qsort(text, cnt_lines, sizeof(char*), reverse_comp);
//    MyQiuckSort(sorted_text, cnt_lines - 1, sizeof(char*), comp);
...
//    printf("%s", reverse_first);

    free(reverse_first);
    free(reverse_second);
    return strcmp(reverse_first, reverse_second);
}
